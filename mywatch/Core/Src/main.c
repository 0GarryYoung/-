...
int main(void)
{
  ...
  DelayMs(1000);
  OLED_CLS();
  for (i = 0; i < 2; i++) OLED_ShowCN(i * 16, 4, i + 16, 0);
  for (i = 0; i < 2; i++) OLED_ShowCN(i * 16 + 48, 4, i + 18, 0);
  for (i = 0; i < 2; i++) OLED_ShowCN(i * 16 + 95, 4, i + 20, 0);
  IIC_init();
  adxl345_init();
  Init_MAX30102();
  uart1_Init(9600);
...
void DisplayTime(void)
{
    ...
    OLED_ShowCN(i * 16 + 88, 0, 0, setn + 1 - 4);
    switch (SysDate.week)
    {
    case 1:
        OLED_ShowCN(i * 16 + 104, 0, 1, setn + 1 - 4);
        break;

    case 2:
        OLED_ShowCN(i * 16 + 104, 0, 2, setn + 1 - 4);
        break;

    case 3:
        OLED_ShowCN(i * 16 + 104, 0, 3, setn + 1 - 4);
        break;

    case 4:
        OLED_ShowCN(i * 16 + 104, 0, 4, setn + 1 - 4);
        break;

    case 5:
        OLED_ShowCN(i * 16 + 104, 0, i + 5, setn + 1 - 4);
        break;

    case 6:
        OLED_ShowCN(i * 16 + 104, 0, 6, setn + 1 - 4);
        break;

    case 7:
        OLED_ShowCN(i * 16 + 104, 0, 7, setn + 1 - 4);
        break;
    }
    x = 0;
...
void CHECK_NEW_MCU(void)
{
    ...
    DelayMs(100);
    STMFLASH_Read(FLASH_SAVE_ADDR + 0x20, &bushu, 1);
