...
#include "bsp_types.h"
/************************************************
        ADXL345 digital accelerometer driver
  Ported to the multi-instance software I2C (bus hi2c_adxl = PA6 SCL / PA7 SDA).
************************************************/
...
#define	slaveaddress   0xA6	  //ADXL345 I2C write address (ALT ADDRESS pin low)
